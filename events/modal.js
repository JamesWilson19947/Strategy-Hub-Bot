    ...
    execute(interaction) {
        if (!interaction.isModalSubmit()) return;
            ...
            if (interaction.customId === 'teamssplit') {
                ...
                if(teams.length < 2){
                    interaction.reply({ content: `${interaction.user.toString()} you must enter at least two people on different lines...`, ephemeral: true });
                    return true;
                }
